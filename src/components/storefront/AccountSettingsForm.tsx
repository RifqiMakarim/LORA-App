            ...
            <div className="bg-white rounded-3xl border border-slate-200/90 shadow-sm p-4 sm:p-6 md:p-10 space-y-6 sm:space-y-8 w-full max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 pb-6 border-b border-slate-100">
                    ...
                    >
                        ...
                        {/* Lingkaran Avatar */}
                        <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-amber-100 shadow-md flex items-center justify-center overflow-hidden bg-gradient-to-tr from-terracotta to-amber-500 text-white font-extrabold text-3xl font-outfit flex-shrink-0 transition-transform group-hover:scale-105">
                            {isUploadingAvatar ? (
                            ...
                            <span className="absolute bottom-1 right-1 p-1 bg-emerald-500 text-white rounded-full ring-2 ring-white z-20" title="Akun Terverifikasi">
                    ...
                    <div className="text-center sm:text-left space-y-1">
                        ...
                        <div className="pt-1.5 flex items-center justify-center sm:justify-start gap-2 flex-wrap">
                            <button
                                ...
                                className="px-3 py-1 bg-amber-50 hover:bg-amber-100 border border-amber-200 text-amber-900 rounded-xl text-[11px] font-bold transition-all inline-flex items-center gap-1.5 cursor-pointer"
                            >
                                <Camera className="w-3.5 h-3.5 text-terracotta" />
                                <span>{avatarUrl ? 'Ganti Foto Profil' : 'Unggah Foto Profil'}</span>
                            </button>
                            <span className="px-2.5 py-1 bg-slate-100 border border-slate-200 text-slate-700 rounded-xl text-[10px] font-bold uppercase tracking-wider">
                                {initialProfile?.is_seller ? 'Mitra Penjual & Pembeli' : 'Pembeli Terverifikasi'}
                            </span>
                        </div>
                    </div>
                </div>
